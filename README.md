...
**Thanks for downloading the Splunk app for Heroku!**
...
__Sanity checkpoint: It is essential the port you recieve data is open and traffic is not blocked.__
...
In some cases you may not have any logs that populate the search just yet - __this is usually a good thing where errors are concerened.__
